...
export const initializeTransactionEntry = async (payload) => {
  try {
    const response = await api.post("/payment/initialize-entry", payload);
    return response.data;
  } catch (error) {
    if (error.response) {
      // Add server response details to the error
...
export const verifyTransactionFundSavings = async (reference) => {
  try {
    const response = await api.get(`/payment/verify-savings/${reference}`);
    return response.data;
  } catch (error) {
    if (error.response) {
      // Add server response details to the error
...
export const verifyTransactionFundLoan = async (reference) => {
  try {
    const response = await api.get(`/payment/verify-loan/${reference}`);
    return response.data;
  } catch (error) {
    if (error.response) {
      // Add server response details to the error
...
export const verifyTransactionEntry = async (reference) => {
  try {
    const response = await api.get(`/payment/verify-entry/${reference}`);
    return response.data;
  } catch (error) {
    if (error.response) {
      // Add server response details to the error
...
export const getTransactions = async (payload) => {
  try {
    const response = await api.get(
      `/transaction/user/${payload.userId}?page=${payload.page}`
    );
    return response.data;
  } catch (error) {
    if (error.response) {
...
export const getUnUsedLoanFormTransactions = async (payload) => {
  try {
    const response = await api.get(
      `/transaction/unused-loan-application`
    );
    return response.data;
  } catch (error) {
    if (error.response) {
